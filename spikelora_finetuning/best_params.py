...
BEST_PARAMS = {
  ...
  "qnli": {'learning_rate': 3e-4, 'batch_size': 32, 'num_epochs': 5, 'lora_r': 8, 'lora_dropout': 0.0, 'v_threshold': .1}, # 12
  "mnli": {'learning_rate': 3e-4, 'batch_size': 32, 'num_epochs': 5, 'lora_r': 8, 'lora_dropout': 0.0, 'v_threshold': .1}, # 12
  "qqp": {'learning_rate': 3e-4, 'batch_size': 32, 'num_epochs': 10, 'lora_r': 8, 'lora_dropout': 0.0, 'v_threshold': .1}, # 12

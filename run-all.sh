...
qsub -v TASK=cola,SEED=1,RANK=1 deberta_4.sh -N cola-spike-1-1 -l walltime=01:00:00 #
qsub -v TASK=cola,SEED=2,RANK=1 deberta_4.sh -N cola-spike-2-1 -l walltime=01:00:00 #
qsub -v TASK=cola,SEED=3,RANK=1 deberta_4.sh -N cola-spike-3-1 -l walltime=01:00:00 #
qsub -v TASK=cola,SEED=4,RANK=1 deberta_4.sh -N cola-spike-4-1 -l walltime=01:00:00 #
qsub -v TASK=cola,SEED=5,RANK=1 deberta_4.sh -N cola-spike-5-1 -l walltime=01:00:00 #

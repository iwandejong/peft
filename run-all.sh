...
qsub -v TASK=cola,LORA=true,SEED=3,RANK=16 deberta_4.sh -N cola-lora-3-16 -l walltime=03:00:00
...
qsub -v TASK=cola,LORA=true,SEED=1,RANK=32 deberta_4.sh -N cola-lora-1-32 -l walltime=05:00:00
qsub -v TASK=cola,LORA=true,SEED=2,RANK=32 deberta_4.sh -N cola-lora-2-32 -l walltime=05:00:00
qsub -v TASK=cola,LORA=true,SEED=3,RANK=32 deberta_4.sh -N cola-lora-3-32 -l walltime=05:00:00
qsub -v TASK=cola,LORA=true,SEED=4,RANK=32 deberta_4.sh -N cola-lora-4-32 -l walltime=05:00:00
qsub -v TASK=cola,LORA=true,SEED=5,RANK=32 deberta_4.sh -N cola-lora-5-32 -l walltime=05:00:00
qsub -v TASK=cola,SEED=1,RANK=32 deberta_4.sh -N cola-spike-1-32 -l walltime=05:00:00
qsub -v TASK=cola,SEED=2,RANK=32 deberta_4.sh -N cola-spike-2-32 -l walltime=05:00:00
qsub -v TASK=cola,SEED=3,RANK=32 deberta_4.sh -N cola-spike-3-32 -l walltime=05:00:00
qsub -v TASK=cola,SEED=4,RANK=32 deberta_4.sh -N cola-spike-4-32 -l walltime=05:00:00
qsub -v TASK=cola,SEED=5,RANK=32 deberta_4.sh -N cola-spike-5-32 -l walltime=05:00:00
